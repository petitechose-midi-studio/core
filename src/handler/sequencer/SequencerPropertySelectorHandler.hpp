...
public:
    ...
    SequencerPropertySelectorHandler(
        ...
        oc::type::ScopeID scopeId, NowProvider nowProvider,
...
private:
    ...
    int32_t prepared_segment_before_value_ = 0;
    uint8_t prepared_segment_key_ = 0;
    bool prepared_segment_active_ = false;
