...
inline oc::note::sequencer::StepSequencerScaleSettings effectiveScaleSettings(
...
inline bool resetActiveContentStep(
...
inline bool appendStepClipboardEntry(
    const core::state::sequencer::SequencerState& sequencer,
    uint8_t step,
    uint8_t firstStep,
...
inline bool writeRootStepFromClipboardEntry(
    core::state::sequencer::SequencerState& sequencer,
...
inline bool writeChildStepFromClipboardEntry(
    core::state::sequencer::SequencerState& sequencer,
    const core::state::SequencerStepClipboardEntry& entry,
    const oc::note::sequencer::StepSequencerGraph* sourceGraph,
    uint8_t targetStep
