...
inline constexpr uint8_t
    PROJECT_MODULATION_GRAPH_GLOBAL_DEPTH_VERSION_MINOR = 2U;
inline constexpr uint8_t PROJECT_MODULATION_GRAPH_ADSR_VERSION_MINOR = 3U;
...
inline constexpr uint32_t PROJECT_MODULATOR_SOURCE_DIRECTORY_SIZE = 36U;
