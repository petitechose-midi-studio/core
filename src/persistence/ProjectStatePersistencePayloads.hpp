...
inline constexpr uint8_t PROJECT_STATE_CHUNK_VERSION_MINOR = 2;
...
inline constexpr uint8_t PROJECT_EDITING_CC_LANE_DEFAULTS_MARKER = 0xC1U;
...
struct ProjectEditingPayload {
    ...
    uint8_t ccLaneDefaultsMarker = PROJECT_EDITING_CC_LANE_DEFAULTS_MARKER;
    uint8_t ccLaneDefaultControllers[
        core::state::project::PROJECT_CC_LANE_DEFAULT_COUNT
    ] = {
        core::state::project::PROJECT_CC_LANE_DEFAULT_CONTROLLERS[0],
        core::state::project::PROJECT_CC_LANE_DEFAULT_CONTROLLERS[1],
        core::state::project::PROJECT_CC_LANE_DEFAULT_CONTROLLERS[2],
        core::state::project::PROJECT_CC_LANE_DEFAULT_CONTROLLERS[3],
    };
};
