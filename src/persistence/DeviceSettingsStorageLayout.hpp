 ...
 *
 * Offsets and VERSION define the exact current MIDI-sync settings format.
 * Pre-V1 readers accept this version only.
 */
namespace layout {
...
constexpr uint32_t STORAGE_END = ADDR_SYNC_AUTO_LOCK_CLOCKS + 1;
