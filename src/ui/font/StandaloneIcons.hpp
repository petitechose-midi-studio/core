// Auto-generated | 22 icons | 2026-06-04
#pragma once
...
enum class Size : uint8_t { S = 12, M = 14, L = 16 };
    ...
    constexpr const char* KNOB = "\xEE\x80\x8A";
    constexpr const char* LOCK = "\xEE\x80\x8B";
    constexpr const char* MIDI_CC = "\xEE\x80\x8C";
    constexpr const char* MIDI_CHANNEL = "\xEE\x80\x8D";
    constexpr const char* NOTE = "\xEE\x80\x8E";
    constexpr const char* NOTE_PROP_GATE = "\xEE\x80\x8F";
    constexpr const char* NOTE_PROP_NUDGE = "\xEE\x80\x90";
    constexpr const char* NOTE_PROP_PITCH = "\xEE\x80\x91";
    constexpr const char* NOTE_PROP_RANDOM = "\xEE\x80\x92";
    constexpr const char* NOTE_PROP_VEL = "\xEE\x80\x93";
    constexpr const char* SETTINGS_GEAR = "\xEE\x80\x94";
