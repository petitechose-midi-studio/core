...
public:
    ...
    using TelemetryReadView = MidiCcResolutionTelemetryExchange::ReadView;
...
private:
    ...
    MidiCcResolutionTelemetryExchange telemetry_exchange_{};
    std::array<
        DesiredValue,
        core::state::shared::MidiCcResolutionTelemetry::MAX_DESTINATIONS
    > desired_values_{};
    ...
    ProjectControlClockPublisher control_clock_{};
    ProjectModulationTriggerQueue project_trigger_queue_{};
