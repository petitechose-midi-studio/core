...
inline constexpr std::array<DataManagerCommandSpec, 9> DATA_MANAGER_COMMAND_SPECS = {{
    {DataManagerCommand::MACRO_SAVE_SLOT,
     DataManagerContext::MACRO,
     DataManagerSlotDomain::MACRO_LIBRARY,
     DataManagerCommandAction::SAVE,
     "Save Macro",
     'M',
     false},
    {DataManagerCommand::MACRO_LOAD_SLOT,
     DataManagerContext::MACRO,
     DataManagerSlotDomain::MACRO_LIBRARY,
     DataManagerCommandAction::LOAD,
     "Load Macro",
     'M',
     false},
    {DataManagerCommand::MACRO_ERASE_SLOT,
     DataManagerContext::MACRO,
     DataManagerSlotDomain::MACRO_LIBRARY,
     DataManagerCommandAction::ERASE,
     "Erase Macro",
     'M',
     false},
    {DataManagerCommand::SEQ_SAVE_PATTERN_SLOT,
     DataManagerContext::SEQUENCER,
     DataManagerSlotDomain::SEQ_PATTERN_LIBRARY,
     DataManagerCommandAction::SAVE,
     "Save Pattern",
     'P',
     false},
    {DataManagerCommand::SEQ_LOAD_PATTERN_SLOT,
     DataManagerContext::SEQUENCER,
     DataManagerSlotDomain::SEQ_PATTERN_LIBRARY,
     DataManagerCommandAction::LOAD,
     "Load Pattern",
     'P',
     false},
    {DataManagerCommand::SEQ_ERASE_PATTERN_SLOT,
     DataManagerContext::SEQUENCER,
     DataManagerSlotDomain::SEQ_PATTERN_LIBRARY,
     DataManagerCommandAction::ERASE,
     "Erase Pattern",
     'P',
     false},
    {DataManagerCommand::SEQ_SAVE_SET_SLOT,
     DataManagerContext::SEQUENCER,
     DataManagerSlotDomain::SEQ_SET_LIBRARY,
     DataManagerCommandAction::SAVE,
     "Save Set",
     'S',
     false},
    {DataManagerCommand::SEQ_LOAD_SET_SLOT,
     DataManagerContext::SEQUENCER,
     DataManagerSlotDomain::SEQ_SET_LIBRARY,
     DataManagerCommandAction::LOAD,
     "Load Set",
     'S',
     true},
    {DataManagerCommand::SEQ_ERASE_SET_SLOT,
     DataManagerContext::SEQUENCER,
     DataManagerSlotDomain::SEQ_SET_LIBRARY,
     DataManagerCommandAction::ERASE,
     "Erase Set",
...
static_assert(dataManagerSpecCountForContext(DataManagerContext::MACRO) <=
                  static_cast<uint8_t>(DATA_MANAGER_MAX_COMMANDS_PER_CONTEXT),
              "Macro command list exceeds DATA_MANAGER_MAX_COMMANDS_PER_CONTEXT");
static_assert(dataManagerSpecCountForContext(DataManagerContext::SEQUENCER) <=
                  static_cast<uint8_t>(DATA_MANAGER_MAX_COMMANDS_PER_CONTEXT),
              "Sequencer command list exceeds DATA_MANAGER_MAX_COMMANDS_PER_CONTEXT");
...
inline constexpr const char* dataManagerCommandLabel(DataManagerCommand cmd) {
    if (const auto* spec = dataManagerCommandSpec(cmd)) {
        return spec->label;
    }
...
inline constexpr int dataManagerCommandIndex(DataManagerContext context,
...
inline constexpr bool dataManagerCommandSupportsSetLoadMode(DataManagerCommand cmd) {
    if (const auto* spec = dataManagerCommandSpec(cmd)) {
        return spec->supportsSetLoadMode;
    }
