...
void test_graph_payload_inspection_rejects_malformed_cycles_and_depth() {
    ...
    core::state::sequencer::SequencerDetachedEditor dangling;
    ...
    core::state::sequencer::SequencerDetachedEditor oversized;
    const auto sequence =
    ...
    core::state::sequencer::SequencerDetachedEditor cyclic;
    const auto cycle =
    ...
    core::state::sequencer::SequencerDetachedEditor deep;
    uint16_t parent = 0U;
...
void test_unversioned_copy_reset_and_resize_do_not_signal_revision() {
    ...
    core::state::sequencer::SequencerDetachedEditor versioned;
