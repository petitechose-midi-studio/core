...
detect_platform() {
    ...
    TOOLS_DIR="$SCRIPT_DIR/tools/${PLATFORM_ID}"
    ENV_FILE="$SCRIPT_DIR/.env.${PLATFORM_ID}"

    echo -e "  ${CYAN}→${NC} Platform: ${CYAN}${PLATFORM_ID}${NC}"
}
...
# =============================================================================
# Create .env file (platform-specific)
# =============================================================================
create_env() {
...
ENV_EOF
    ...
    echo -e "  ${GREEN}✓${NC} .env.${PLATFORM_ID} created"
}
