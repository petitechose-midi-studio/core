...
def persistence_lease_contract_errors(files: dict[str, str]) -> list[str]:
    ...
    for contract in (
        ...
        (job_rpc_header, r"VERSION\s*=\s*5", "wire version changes require coordinated qualification"),
        (job_rpc_header, r"HEADER\s*=\s*32", "unified header must remain 32 bytes"),
